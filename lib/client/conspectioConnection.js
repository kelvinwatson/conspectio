...
class ConspectioConnection {
  constructor(eventId, role, videoEl, userChosenVideoDeviceId, viewerHandlers, options) {
    this.eventId = eventId;
    this.role = role;
    this.videoEl = videoEl;
    this.userChosenVideoDeviceId = userChosenVideoDeviceId;
  ...
  start() {
    if(this.role && this.role === 'broadcaster') {
      ...
      setupGetUserMedia(this.videoEl, this.userChosenVideoDeviceId, (stream) => {
