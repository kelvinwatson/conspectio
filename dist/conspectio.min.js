...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConspectioConnection = function () {
	  function ConspectioConnection(eventId, role, videoEl, viewerHandlers, options) {
	  ...
	  _createClass(ConspectioConnection, [{
	    ...
	    value: function start() {
	      if (this.role && this.role === 'broadcaster') {
	        ...
	        setupGetUserMedia(this.videoEl, function (stream) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setupGetUserMedia = function setupGetUserMedia(videoEl, callback) {
