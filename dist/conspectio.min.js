...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!window.conspectio) {
	  ...
	  conspectio.ConspectioConnection = __webpack_require__(29);

	  // import the ConspectioManager module
	  conspectio.ConspectioManager = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var send = __webpack_require__(11);
	...
	var ConspectioBroadcaster = function () {
	  ...
	  _createClass(ConspectioBroadcaster, [{
	    ...
	    value: function createOfferWrapper(toId) {
	      var _this = this;

	      this.pc.createOffer(function (offer) {
	        var toId = toId || _this.viewerId;
	        send(toId, {
	          type: "offer",
	          offer: offer
	        }, _this.originId);
	        ...
	        var bandwidth = _this.setSDPBandwidth(tmp.sdp);
	        var sdpObj = {
	          type: 'offer',
	          sdp: bandwidth
	        };
	    ...
	    value: function replaceStreamWrapper(sourceStream) {
	      this.pc.removeStream(this.stream);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConspectioBroadcaster = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setupGetUserMedia = __webpack_require__(32);
	var broadcasterRTCEndpoint = __webpack_require__(28);
	var viewerRTCEndpoint = __webpack_require__(33);

	var ConspectioConnection = function () {
	  function ConspectioConnection(eventId, role, videoEl, userChosenVideoDeviceId, viewerHandlers, options) {
	  ...
	  _createClass(ConspectioConnection, [{
	    ...
	    value: function start() {
	      if (this.role && this.role === 'broadcaster') {
	        ...
	        setupGetUserMedia(this.videoEl, this.userChosenVideoDeviceId, function (stream) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pc = void 0; //On Safari, "this" loses context, so store it here
	var localVideoEl = void 0;
	// custom wrapper class over RTCPeerConnection object

	var ConspectioViewer = function () {
	  function ConspectioViewer(broadcasterId, viewerHandlers, originId, videoEl) {
	  ...
	  _createClass(ConspectioViewer, [{
	    ...
	    value: function init() {
	      ...
	      var that = this;
	      pc.setRemoteStream = function (stream) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setupGetUserMedia = function setupGetUserMedia(videoEl, userChosenVideoDeviceId, callback) {
	  ...
	  if (userChosenVideoDeviceId) {
	    ...
	    //uses FRONT facing camera by default if one is available
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConspectioViewer = __webpack_require__(31);
	var ConspectioBroadcaster = __webpack_require__(10);

	var viewerRTCEndpoint = function viewerRTCEndpoint(eventTag, viewerHandlers, videoEl) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  // Browser shims.
	  var chromeShim = __webpack_require__(60) || null;
	  var edgeShim = __webpack_require__(62) || null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SDPUtils = __webpack_require__(52);
	var browserDetails = __webpack_require__(1).browserDetails;
